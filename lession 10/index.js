...
console.log(tongchan([12, 12, 12, 3]));
/**
...
// 1. In ra danh sách các sản phẩm có price >=50
console.log(`Bài 1`);
function listPricesthan50(products) {
...
console.log(listPricesthan50(products));
// 2. In ra danh sách các sản phẩm có đánh giá từ 4 trở lên. (dựa vào giá trị "rate")
console.log(`Bài 2`);
function listRatesthan4(products) {
  for (let i = 0; i < products.length; i++) {
...
console.log(listRatesthan4(products));

// 3. In ra danh sách các sản phẩm thuộc category: "women's clothing"
console.log(`Bài 3`);
function listSamecategory(products) {
  for (let i = 0; i < products.length; i++) {
...
console.log(listSamecategory(products));
...
console.log(listCategory(products));
 ...
 */
console.log(`bài 6`);
function listNumberofcategory(products) {
  let men = 0;
  let women = 0;
  let jewelery = 0;
  let elec = 0;
  ...
  for (i = 0; i < products.length; i++) {
    if (products[i].category === "men's clothing") {
      men += 1;
    } else if (products[i].category === "women's clothing") {
      women += 1;
    } else if (products[i].category === "jewelery") {
      jewelery += 1;
    } else if (products[i].category === "electronic") {
      elec += 1;
    }
  }
  return products_by_type;
}
console.log(listNumberofcategory(products));
